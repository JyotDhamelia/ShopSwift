            ...
            <section className="text-gray-400 bg-gray-900 mt-5 flex justify-center items-center capitalize mx-3">
                <div className="container mx-auto flex flex-col justify-center items-center">
                    <div className="lg:w-2/3 md:w-1/2 bg-gray-800 bg-opacity-50 rounded-lg p-8 w-full">
                        <h2 className="text-white text-lg font-medium title-font mb-5">Edit category</h2>
                        <form onSubmit={(event) => this.UpdateCategory(event)}>
                            <div className="mb-4">
                                <label htmlFor="title" className="leading-7 text-sm text-gray-400">Change title</label>
                                <input
                                    type="text"
                                    id="title"
