...
function AdminLogin() {
    ...
    return (<>
        <section className="text-gray-400 bg-indigo-200 body-font min-h-screen flex justify-center items-center">
            <div className="container flex flex-col justify-center items-center mx-auto">
                <div className="lg:w-2/3 md:w-1/2 bg-indigo-300 bg-opacity-50 rounded-lg p-8 w-full">
                    <h2 className="text-gray-900 text-lg font-bold title-font mb-5 ">Log In</h2>
                    <form method="post" encType="multipart/form/data" onSubmit={(event) => ConfirmLogin(event)}>
                        <div className="relative mb-4">
                            <label htmlFor="email" className="leading-7 text-sm text-gray-900 font-bold">Email</label>
                        ...
                        <div className="relative mb-4">
                            <label htmlFor="Password" className="leading-7 text-sm text-gray-900 font-bold">Password</label>
                    ...
                    <p className="text-s mt-3 text-gray-800">Can't Log In? <a href="" className="text-blue-500">Recover Account</a></p>
                </div>
            </div>
        </section>
    </>);
